...
install_anaconda() {
    ...
    #sudo ${ANACONDA_PREFIX}/bin/conda install --yes --freeze python=3.9 pyarrow=2.0.0 s3fs=0.5.2 cartopy=0.18.0
    sudo ${ANACONDA_PREFIX}/bin/conda install --yes --freeze cartopy=0.18.0 geos=3.8.0 proj=7.0.1 pyshp=2.1.3 shapely=1.7.1
    sudo ${ANACONDA_PREFIX}/bin/pip install pyarrow==8.0.0 s3fs==2021.7.0 contextily==1.2.0 geopandas==0.11.1
}
