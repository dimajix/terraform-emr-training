...
install_notebooks() {
    ...
    git clone https://github.com/dimajix/pyspark-ml-crashcourse.git /home/hadoop/pyspark-ml-crashcourse
    chown hadoop:hadoop /home/hadoop/pyspark-ml-crashcourse
}
